...
/* harmony export */   n: () => (/* binding */ COMMAND_MAP)
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   n0: () => (/* reexport safe */ _command_map__WEBPACK_IMPORTED_MODULE_0__.n),
...
chrome.runtime.onMessage.addListener(function (request, _sender, sendResponse) {
  if (request.type === commands__WEBPACK_IMPORTED_MODULE_0__/* .COMMAND_BUS_REQUEST_MESSAGE */ .rx) {
    var serializedCommand = request.data;
    var commandDefinition = commands__WEBPACK_IMPORTED_MODULE_0__/* .COMMAND_MAP */ .n0[serializedCommand.name];
    if (!commandDefinition) {
      var error = new Error("Missing command definition for ".concat(serializedCommand.name, ". Make sure it's added to COMMAND_MAP"));
      throw error;
    }
    var command = new commandDefinition(serializedCommand.payload);
    command.id = serializedCommand.id;
    command.handle().then(function (response) {
